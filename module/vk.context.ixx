...
namespace vk::context {
    ...
    export struct CameraState {
        ...
        toolkit::math::Vec3 target{0, 0, 0};
        float distance{5.0f};
        float yaw_deg{-45.0f};
        float pitch_deg{25.0f};

        // Fly mode parameters
        toolkit::math::Vec3 eye{0, 0, 5};
    ...
    public:
        ...
        [[nodiscard]] const toolkit::math::Mat4& view_matrix() const {
            return view_;
        }
        [[nodiscard]] const toolkit::math::Mat4& proj_matrix() const {
            return proj_;
        }
        [[nodiscard]] const CameraState& state() const {
            return state_;
        }
        [[nodiscard]] toolkit::math::Vec3 eye_position() const;
    ...
    private:
        ...
        CameraState state_{};
        toolkit::math::Mat4 view_{};
        toolkit::math::Mat4 proj_{};
